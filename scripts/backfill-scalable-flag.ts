...
async function main() {
  ...
  console.log(`Found ${candidates.length} product(s) with scale details set but isScalable: false:\n`);
  ...
  console.log("Note: this only sets the flag. If any of these also need a scaleUnit,");
  console.log("pricePerUnit, or scaleStep value and don't have one, edit them individually.");
}
